# sodaCAD project file
# (c) Ries van Twisk (librecad@rvt.dds.nl)
TEMPLATE = app
DEFINES += QC_APPKEY="\"/sodaCAD\""
DEFINES += QC_APPNAME="\"sodaCAD\""
DEFINES += QC_COMPANYNAME="\"sodaCAD\""
DEFINES += QC_COMPANYKEY="\"sodaCAD\""
...
unix { 
    ...
    macx { 
        CONFIG += x86 x86_64
        TARGET = sodaCAD
        DEFINES += QC_APPDIR="\"sodaCAD\""
        DEFINES += QINITIMAGES_LIBRECAD="qInitImages_sodaCAD"
...
IMAGES += res/main/contents.png \
    ...
    res/main/sodacad16.png \
    res/main/sodacad.png
